...
<!-- BEGIN allostatik v0.3.11 sha256:9e2268059b59 (managed — updated by the upgrade routine, gated on a verbatim diff; your edits belong outside it. Project additions — an extra canonical file to load, say — go below the END marker, outside the fence) -->
